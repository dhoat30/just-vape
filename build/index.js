...
/* harmony import */ var _modules_Optimization__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./modules/Optimization */ "./src/modules/Optimization.js");
/* harmony import */ var _modules_QuoteFeature_QuoteAjax__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./modules/QuoteFeature/QuoteAjax */ "./src/modules/QuoteFeature/QuoteAjax.js");
...
window.onload = function () {
  ...
  // optimization 
  const optimization = new _modules_Optimization__WEBPACK_IMPORTED_MODULE_23__["default"]();

  // quote ajax
  const quoteAjax = new _modules_QuoteFeature_QuoteAjax__WEBPACK_IMPORTED_MODULE_24__["default"]();
  // enquiry modal 
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Optimization);
...
class EveryOwlCarousel {
  ...
  events() {
    $(window).on('load', () => {
      ...
      this.productsCarousel('.product-list-container .products', true, false, false);
...
class VariationSwatches {
  constructor() {
    this.swatchesContainer = $('.variation-swatch');
    this.initEvents();
  }
  initEvents() {
  ...
  changeArchivePageImage(event) {
    const swatch = $(event.currentTarget);
    const imageUrl = swatch.data('image');
  ...
  onSwatchClick(event) {
    ...
    $('.selected-variation-label').html(`<span class="title">Selected swatch: </span><span class="value">${variationLabel}</span>`);
