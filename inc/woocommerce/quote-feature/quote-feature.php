...
$product_details_json = json_encode($product_details);
    ...
    <div class="webduel-quantity">
        <label for="quantity" class="subtitle1">Quantity: </label for="quantity">
        <input aria-label="Quantity" type="number" class="qty" name="quantity" value="1" min="1" step="1">
    </div>
    <?php
